...
@patch("app_core.utils.net.get_interface_ips", return_value={
    "eth0": ["1.2.3.4"],
    "eth1": ["5.6.7.8"],
})
...
@patch.object(net, "get_interface_ips", return_value={
    "wlan0": ["10.0.0.5"],
})
...
@pytest.fixture
def wifi_env():
    with patch("app_core.utils.net.os.listdir", return_value=["wlan0"]), \
         patch("app_core.utils.net.os.path.isdir", return_value=True), \
         patch("app_core.utils.net.detect_interface_type", return_value="wifi"), \
         patch("app_core.utils.net.get_route_metrics", return_value={}), \
         patch("app_core.utils.net.get_interface_ips", return_value={"wlan0": ["10.0.0.5"]}), \
         patch("app_core.utils.net._read_sysfs",
               side_effect=["aa:bb:cc", "up", "1", "1000"]), \
         patch("app_core.utils.net.get_wifi_info") as mock_wifi:
