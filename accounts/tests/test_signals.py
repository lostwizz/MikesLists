...
__updated__ = "2026-01-19 21:53:51"
###############################################################################
# /srv/django/venv-dev/bin/python /srv/django/MikesLists_dev/manage.py test accounts.tests --settings=MikesLists.settings.dev --noinput -v 3 --debug-mode --traceback --force-color --shuffle
# python manage.py test accounts.tests --settings=MikesLists.settings.dev --noinput -v 3 --debug-mode --traceback --force-color --shuffle
# python manage.py test accounts.tests --settings=MikesLists.settings.dev
# python manage.py test accounts --settings=MikesLists.settings.dev
