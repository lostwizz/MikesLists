...
# r"""
# items.py
# app_ToDo.models.items
# /srv/django/MikesLists_dev/app_ToDo/models/items.py
...
# __updated__ = "2026-01-23 01:16:19"
# ###############################################################################
...
#     short_title = models.CharField(max_length=25, blank=True, null=True,default=None)
...
#     expiryInterval = models.CharField(max_length=50, null=True, blank=True, default=None)
#     expiryAbsolute = models.DateTimeField(null=True, blank=True, default=None)
...
#             return (
#                 self.version[: match.start()]
#                 + str(number + 1)
#                 + self.version[match.end() :]
#             )
