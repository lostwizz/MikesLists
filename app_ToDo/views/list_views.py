...
r"""
list_views.py
app_ToDo.views.list_views
/srv/django/MikesLists_dev/app_ToDo/views/list_views.py
...
__updated__ = "2026-01-23 20:52:38"
###############################################################################
...
from app_ToDo.forms.item_forms import ItemForm   # used for inline item creation


# ---------------------------------------------------------------------
# LIST Dapp_SHBOARD (shows all items for the current user)
# ---------------------------------------------------------------------
...
def list_dashboard(request):
    ...
    return render(request, "app_ToDo/lists.html", {"items": items})
...
def list_all(request):
    ...
    return render(request, "app_ToDo/lists.html", {"lists": lists})
...
def list_create(request):
    if request.method == "POST":
        ...
        if not name:
            ...
            return redirect("app_todo:list_dashboard")

    return render(request, "app_ToDo/list_form.html")
...
def list_edit(request, pk):
    ...
    return render(request, "app_ToDo/list_form.html", {"list": todo_list})
